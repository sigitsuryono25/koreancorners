                ...
                <div class="mag-content-left-hny col-lg-8">
                        ...
                        <div class="maghny-grids-inf row">
                            <?php foreach ($idol as $i) { ?>
                                <div class="maghny-gd-1 col-lg-6 col-md-6 mt-3">
                                    ...
                                    <p><?php echo $this->etc->truncatedText($i->content, 100) ?> [...]</p>
                        ...
                        <div class="maghny-grids-inf row">
                            <?php foreach ($drama as $key => $d) { ?>
                                <div class="maghny-gd-1 col-md-6">
                                    ...
                                    <p><?php echo $this->etc->truncatedText($d->content, 100) ?> [...]</p>
                                    ...
                                    <div class="mag-small-post col-md-6">
                                        <div class="post-item-grid row mb-4">
                                            <div class="mag-post-thumb col-5">
                                                <img src="<?php echo $d->thumbnail ?>" class="img-fluid" alt="">
                                            </div>
                                ...
                                <div class="maghny-gd-1 col-lg-4 col-md-6">
                                    <div class="maghny-grid">
                                        <figure class="effect-lily">
                                            <img class="img-fluid" src="<?php echo $n->thumbnail ?>">
                                        </figure>
                                    </div>
                                    <p class="font-weight-bold h6" >
                                        <a href="<?php echo site_url($this->etc->yeardate($n->date_post) . $n->slug_title) ?>">
                                            <?php echo $n->title ?>
                                        </a>
                                    </p>
                                    <div class="mag-post-meta mt-3"> 
                    ...
                    <div class="mag-hny-content mb-5">
                        ...
                        <?php foreach ($music as $m) { ?>
                            <div class="maghny-grids-inf row my-3">
                                <div class="mag-post-thumb col-md-6">
                                    <a href="#"><img src="<?php echo $m->thumbnail ?>" class="img-fluid" alt=""></a>

                                </div>
                                <div class="mag-post-fashion-details col-md-6 mt-md-0 mt-4">
                                    <a href="<?php echo site_url($this->etc->yeardate($m->date_post) . $m->slug_title) ?>">
                                        <h4 class="mag-post-head">
                                            <?php echo $m->title ?>
                                        </h4>
                                    </a>
                                    <div class="mag-post-meta mt-2"> 
                                        <span class="author-date"><?php echo date_format(date_create($n->date_post), "M, d Y") ?></span>
                                    </div>
                                    <p class="para my-3">
                                        <?php echo $this->etc->truncatedText($m->content, 1000) ?>
                                    </p>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <?php foreach ($variety as $m) { ?>
                            <div class="maghny-grids-inf row my-3">
                                ...
                                <div class="mag-post-fashion-details col-md-6 mt-md-0 mt-4">
                                    ...
                                    <p class="para my-3">
                                        <?php echo $this->etc->truncatedText($m->content, 200) ?>
                                    </p>
                                </div>
                            </div>
                        <?php } ?>
                            ...
                            <?php foreach ($food as $f) { ?>
                                <div class="maghny-gd-1 col-md-6">
                                    <div class="maghny-grid mb-3">
                                        <a href="#"><img class="img-fluid" src="<?php echo $f->thumbnail ?>" alt=""></a>
                                    </div>
                                    <h5>
                                        <a href="<?php echo site_url($this->etc->yeardate($f->date_post) . $f->slug_title) ?>">
                                            <?php echo $f->title ?>
                                        </a>
                                    </h5>
                                    <p><?php echo $this->etc->truncatedText($f->content, 200) ?></p>
                                    <div class="mag-post-meta mt-2"> 
                                        <span class="author-date"><?php echo date_format(date_create($f->date_post), "M, d Y") ?></span>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
                    ...
                    <div class="mag-hny-content my-5">
                        ...
                        <div class="maghny-grids-inf row">
                            <?php foreach ($fashion as $fs) { ?>
                                <div class="maghny-gd-1 col-md-6">
                                    <div class="maghny-grid mb-3">
                                        <a href="#"><img class="img-fluid" src="<?php echo $fs->thumbnail ?>" alt=""></a>
                                    </div>
                                    <h5>
                                        <a href="<?php echo site_url($this->etc->yeardate($fs->date_post) . $fs->slug_title) ?>">
                                            <?php echo $fs->title ?>
                                        </a>
                                    </h5>
                                    <p><?php echo $this->etc->truncatedText($fs->content, 200) ?></p>
                                    <div class="mag-post-meta mt-2"> 
                                        <span class="author-date"><?php echo date_format(date_create($fs->date_post), "M, d Y") ?></span>
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
